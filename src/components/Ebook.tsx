...
<section className="">
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-md sm:text-center">
            ...
            <div className="mb-8">
                <img src="/mockup-ebook.png" alt="Ebook" className="mx-auto w-72 sm:w-96" />
            </div>
          ...
          <form onSubmit={handleSubmit} className="">
              <div className="flex-col gap-2 items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                ...
                <div className="mb-2 md:mb-4">
                  <button type="submit" className="py-3 px-5 w-full text-sm font-black text-center text-white rounded-lg border cursor-pointer bg-primary-700 border-primary-600 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">¡Obtener Ahora!</button>
                </div>
